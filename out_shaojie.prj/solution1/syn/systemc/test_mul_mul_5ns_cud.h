...
// ==============================================================
#ifndef __test_mul_mul_5ns_cud__HH__
#define __test_mul_mul_5ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_5ns_cud) {
    ...
    SC_CTOR(test_mul_mul_5ns_cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
