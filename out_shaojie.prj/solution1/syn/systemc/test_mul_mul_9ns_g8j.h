...
// ==============================================================
#ifndef __test_mul_mul_9ns_g8j__HH__
#define __test_mul_mul_9ns_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_9ns_g8j) {
    ...
    SC_CTOR(test_mul_mul_9ns_g8j):  ACMP_smul_us_U ("ACMP_smul_us_U") {
