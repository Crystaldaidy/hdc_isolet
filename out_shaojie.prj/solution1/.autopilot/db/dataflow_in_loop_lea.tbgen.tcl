set moduleName dataflow_in_loop_lea
set isTopModule 0
...
set C_modelName {dataflow_in_loop_lea}
...
set portList { 
	...
	{ p_0510_0 sc_in sc_lv 5 signal 1 } 
	{ hcl_in_train_V_address0 sc_out sc_lv 20 signal 2 } 
	{ hcl_in_train_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ hcl_in_train_V_d0 sc_out sc_lv 64 signal 2 } 
	{ hcl_in_train_V_q0 sc_in sc_lv 64 signal 2 } 
	{ hcl_in_train_V_we0 sc_out sc_logic 1 signal 2 } 
	{ hcl_in_train_V_address1 sc_out sc_lv 20 signal 2 } 
	{ hcl_in_train_V_ce1 sc_out sc_logic 1 signal 2 } 
	{ hcl_in_train_V_d1 sc_out sc_lv 64 signal 2 } 
	{ hcl_in_train_V_q1 sc_in sc_lv 64 signal 2 } 
	{ hcl_in_train_V_we1 sc_out sc_logic 1 signal 2 } 
	{ compute1_V_address0 sc_out sc_lv 5 signal 3 } 
	{ compute1_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ compute1_V_d0 sc_out sc_lv 32 signal 3 } 
	{ compute1_V_q0 sc_in sc_lv 32 signal 3 } 
	{ compute1_V_we0 sc_out sc_logic 1 signal 3 } 
	{ compute1_V_address1 sc_out sc_lv 5 signal 3 } 
	{ compute1_V_ce1 sc_out sc_logic 1 signal 3 } 
	{ compute1_V_d1 sc_out sc_lv 32 signal 3 } 
	{ compute1_V_q1 sc_in sc_lv 32 signal 3 } 
	{ compute1_V_we1 sc_out sc_logic 1 signal 3 } 
	{ hcl_rdv3_V_address0 sc_out sc_lv 18 signal 4 } 
	{ hcl_rdv3_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ hcl_rdv3_V_d0 sc_out sc_lv 64 signal 4 } 
	{ hcl_rdv3_V_q0 sc_in sc_lv 64 signal 4 } 
	{ hcl_rdv3_V_we0 sc_out sc_logic 1 signal 4 } 
	{ hcl_rdv3_V_address1 sc_out sc_lv 18 signal 4 } 
	{ hcl_rdv3_V_ce1 sc_out sc_logic 1 signal 4 } 
	{ hcl_rdv3_V_d1 sc_out sc_lv 64 signal 4 } 
	{ hcl_rdv3_V_q1 sc_in sc_lv 64 signal 4 } 
	{ hcl_rdv3_V_we1 sc_out sc_logic 1 signal 4 } 
	...
	{ prototype_V_q0 sc_in sc_lv 64 signal 5 } 
	{ prototype_V_we0 sc_out sc_logic 1 signal 5 } 
	{ prototype_V_address1 sc_out sc_lv 12 signal 5 } 
	{ prototype_V_ce1 sc_out sc_logic 1 signal 5 } 
	{ prototype_V_d1 sc_out sc_lv 64 signal 5 } 
	{ prototype_V_q1 sc_in sc_lv 64 signal 5 } 
	{ prototype_V_we1 sc_out sc_logic 1 signal 5 } 
	...
	{ prototypeCounter_V_q0 sc_in sc_lv 32 signal 6 } 
	{ prototypeCounter_V_we0 sc_out sc_logic 1 signal 6 } 
	{ prototypeCounter_V_address1 sc_out sc_lv 18 signal 6 } 
	{ prototypeCounter_V_ce1 sc_out sc_logic 1 signal 6 } 
	{ prototypeCounter_V_d1 sc_out sc_lv 32 signal 6 } 
	{ prototypeCounter_V_q1 sc_in sc_lv 32 signal 6 } 
	{ prototypeCounter_V_we1 sc_out sc_logic 1 signal 6 } 
	{ p_0510_0_ap_vld sc_in sc_logic 1 invld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_0510_0_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "p_0510_0", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "8", "9"],
		...
		"InputProcess" : [
			{"ID" : "2", "Name" : "match_x4_proc_U0", "ReadyCount" : "match_x4_proc_U0_ap_ready_count"},
			{"ID" : "3", "Name" : "i2_proc_U0", "ReadyCount" : "i2_proc_U0_ap_ready_count"}],
		"OutputProcess" : [
			{"ID" : "3", "Name" : "i2_proc_U0"}],
		"Port" : [
			{"Name" : "hcl_trainLabels_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "match_x4_proc_U0", "Port" : "hcl_trainLabels_V"}]},
			{"Name" : "p_0510_0", "Type" : "None", "Direction" : "I"},
			{"Name" : "hcl_in_train_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "match_x4_proc_U0", "Port" : "hcl_in_train_V"}]},
			{"Name" : "compute1_V", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "i2_proc_U0", "Port" : "compute1_V"}]},
			{"Name" : "hcl_rdv3_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "i2_proc_U0", "Port" : "hcl_rdv3_V"}]},
			{"Name" : "prototype_V", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "i2_proc_U0", "Port" : "prototype_V"}]},
			{"Name" : "prototypeCounter_V", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "i2_proc_U0", "Port" : "prototypeCounter_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.compute2_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match_x4_proc_U0", "Parent" : "0",
		"CDFG" : "match_x4_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		...
		"Port" : [
			{"Name" : "hcl_trainLabels_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "compute2_V1", "Type" : "Memory", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "1"},
			{"Name" : "p_0510_0", "Type" : "None", "Direction" : "I"},
			{"Name" : "hcl_in_train_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "match2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "8",
				"BlockSignal" : [
					{"Name" : "match2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_0510_0_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "p_0510_0_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.i2_proc_U0", "Parent" : "0", "Child" : ["4", "5", "6", "7"],
		"CDFG" : "i2_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "compute2_V1", "Type" : "Memory", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "1"},
			{"Name" : "p_0510_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "p_0510_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "compute1_V", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "match2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "8",
				"BlockSignal" : [
					{"Name" : "match2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "hcl_rdv3_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "prototype_V", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "prototypeCounter_V", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.i2_proc_U0.result_V_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.i2_proc_U0.sum1_V_U", "Parent" : "3"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.i2_proc_U0.test_mul_mul_5ns_bkb_U7", "Parent" : "3"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.i2_proc_U0.test_mul_mul_5ns_cud_U8", "Parent" : "3"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match2_channel_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_0510_0_c_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "65282264", "Max" : "67228520"}
	, {"Name" : "Interval", "Min" : "62350403", "Max" : "62350403"}
]}
...
set Spec2ImplPortList { 
	...
	p_0510_0 { ap_none {  { p_0510_0 in_data 0 5 }  { p_0510_0_ap_vld in_vld 0 1 } } }
