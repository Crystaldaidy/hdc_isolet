...
entity test_prototype_V_ram is 
    generic(
...
architecture rtl of test_prototype_V_ram is 
...
architecture arch of test_prototype_V is
    component test_prototype_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    test_prototype_V_ram_U :  component test_prototype_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
